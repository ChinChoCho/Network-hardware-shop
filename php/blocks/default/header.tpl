<header class="header">
   <div class="header__top top-header">
      <div class="top-header__content _container">
         ...
         <div class="top-header__column">
            <div class="top-header__contacts contacts-header contacts-header_forCart">
               <div class="contacts-header__column">
                  <div class="contacts-header__item contacts-header__item_icon">
                     <div class="contacts-header__label">Санкт-Петербург</div>
      ...
      <div class="bottom-header__container _container">
         ...
         <div class="bottom-header__column">
            <div class="bottom-header__info info-header">
               <div data-da="menu__body,2,640" class="info-header__column">
               ...
               <div class="info-header__column">
                  <div data-da="contacts-header_forCart,1,640" class="info-header__cart">
                     <span>12</span>
                  </div>
               </div>
            </div>
